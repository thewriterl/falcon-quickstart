...
def validate_user_create(req, res, resource, params):
    ...
    try:
        ...
        raise InvalidParameterError('Requisição inválida: %s' % req.context)


class Collection(BaseResource):
    """
    Handle for endpoint: /v2/users
    """
...
class Item(BaseResource):
    """
    Handle for endpoint: /v2/users/{user_id}
    """
    @falcon.before(auth_required)
    def on_get(self, req, res, user_id):
        ...
        try:
            ...
            raise UserNotExistsError('Id do usuário: %s' % user_id)


class Self(BaseResource):
    """
    Handle for endpoint: /v2/users/self
    """
    LOGIN = 'login'
    RESETPW = 'resetpw'
    ...
    def process_login(self, req, res):
        ...
        try:
            ...
            raise UserNotExistsError('E-mail do usuário: %s' % email)
